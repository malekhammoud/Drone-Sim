...
def query_tether(prompt: str, api_url: str = "http://localhost:11434/v1/chat/completions", model: str = "llama3") -> Optional[Dict[str, Any]]:
    """Query local Tether model for tactical edge-case decision making."""
    system_prompt = (
